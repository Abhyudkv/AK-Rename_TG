...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        ...
        InlineKeyboardButton('🍂 𝚂𝚄𝙿𝙿𝙾𝚁𝚃', url='https://t.me/AKVMOVIEHUB')
        ],[
    ...
    if data == "start":
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               ...
               InlineKeyboardButton("❣️ 𝚂𝙾𝚄𝚁𝙲𝙴", url="https://t.me/AKVMOVIEHUB")
               ],[
               InlineKeyboardButton("❤️‍🔥 𝙷𝙾𝚆 𝚃𝙾 𝚄𝚂𝙴  ❤️‍🔥", url='https://t.me/AKVMOVIEHUB')
               ],[
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup( [[
               ...
               InlineKeyboardButton("🖥️ 𝙷𝙾𝚆 𝚃𝙾 𝙼𝙰𝙺𝙴", url="https://t.me/AKVMOVIEHUB")
               ],[
               InlineKeyboardButton("🔒 𝙲𝙻𝙾𝚂𝙴", callback_data = "close"),
               InlineKeyboardButton("◀️ 𝙱𝙰𝙲𝙺", callback_data = "start")
               ]]
